...
///
/// @author scx567888
public final class YearMonthNodeMapper<T extends TemporalAccessor> implements TypeNodeMapper<T, ValueNode> {
    ...
    public YearMonthNodeMapper(Class<? extends TemporalAccessor> type, TemporalQuery<T> temporalQuery) {
        this.type = type;
