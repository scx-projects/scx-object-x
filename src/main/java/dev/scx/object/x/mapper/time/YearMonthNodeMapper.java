...
public final class YearMonthNodeMapper implements TypeNodeMapper<YearMonth, ValueNode> {
    ...
    private static final YearMonthNodeMapperOptions DEFAULT_OPTIONS = new YearMonthNodeMapperOptions();
    ...
    public ValueNode valueToNode(YearMonth value, ObjectToNodeContext context) throws ObjectToNodeException {
        var options = context.getMapperOptions(YearMonthNodeMapperOptions.class, DEFAULT_OPTIONS);
        // 处理时间戳格式
