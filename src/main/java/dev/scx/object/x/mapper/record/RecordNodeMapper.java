...
import static dev.scx.object.x.mapper.record.RecordNodeMapperHelper.trySetAccessible;
...
public final class RecordNodeMapper implements TypeNodeMapper<Object, ObjectNode> {
    ...
    RecordNodeMapper(ClassInfo classInfo) {
        ...
        // 这里尝试开放反射访问权限, 失败忽略.
        trySetAccessible(this.recordConstructor, this.recordComponents);
    }
