...
///
/// @author scx567888
public final class LocalTimeNodeMapper<T extends TemporalAccessor> implements TypeNodeMapper<T, ValueNode> {
    ...
    public LocalTimeNodeMapper(Class<? extends TemporalAccessor> type, TemporalQuery<T> temporalQuery) {
        this.type = type;
