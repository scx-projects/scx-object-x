...
public final class OffsetDateTimeNodeMapper implements TypeNodeMapper<OffsetDateTime, ValueNode> {
    ...
    private static final OffsetDateTimeNodeMapperOptions DEFAULT_OPTIONS = new OffsetDateTimeNodeMapperOptions();
    ...
    public ValueNode valueToNode(OffsetDateTime value, ObjectToNodeContext context) throws ObjectToNodeException {
        var options = context.getMapperOptions(OffsetDateTimeNodeMapperOptions.class, DEFAULT_OPTIONS);
        // 处理时间戳格式
