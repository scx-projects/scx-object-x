...
///
/// @author scx567888
public final class OffsetDateTimeNodeMapper<T extends TemporalAccessor> implements TypeNodeMapper<T, ValueNode> {
    ...
    public OffsetDateTimeNodeMapper(Class<? extends TemporalAccessor> type, TemporalQuery<T> temporalQuery) {
        this.type = type;
