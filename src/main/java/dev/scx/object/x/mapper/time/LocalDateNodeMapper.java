...
///
/// @author scx567888
public final class LocalDateNodeMapper<T extends TemporalAccessor> implements TypeNodeMapper<T, ValueNode> {
    ...
    public LocalDateNodeMapper(Class<? extends TemporalAccessor> type, TemporalQuery<T> temporalQuery) {
        this.type = type;
